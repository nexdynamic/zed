...
use git::{
    ...
    repository::{
        ...
        GitRepository, GitRepositoryCheckpoint, HistoryOperationKind, InitialGraphCommitData,
        LogOrder, LogSource, PushOptions, RefEdit, Remote, RepoPath, ResetMode, SearchCommitArgs,
