...
use git::{
    ...
    repository::{
        ...
        GitCommitTemplate, GitRepository, GitRepositoryCheckpoint, HistoryOperationKind,
...
impl Repository {
    ...
    pub fn continue_history_operation(
        ...
        self.send_job("continue_history_operation", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
    ...
    pub fn skip_history_operation(
        ...
        self.send_job("skip_history_operation", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
    ...
    pub fn abort_history_operation(
        ...
        self.send_job("abort_history_operation", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
    ...
    pub fn start_rebase(
        ...
        self.send_job("start_rebase", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
    ...
    pub fn start_cherry_pick(
        ...
        self.send_job("start_cherry_pick", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
    ...
    pub fn start_revert(
        ...
        self.send_job("start_revert", Some(status.into()), move |repo, cx| async move {
            match repo {
                RepositoryState::Local(LocalRepositoryState {
                    backend,
                    environment,
